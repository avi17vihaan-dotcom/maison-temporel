...
Service({
  ...
  "getProductById": Func([ProductId], [Opt(Product)], ["query"]),
  ...
  "updateQuantity": Func([ProductId, Nat], [], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  const ProductId2 = IDL2.Nat;
  const Collection2 = IDL2.Text;
  ...
  return IDL2.Service({
    ...
    "getProductById": IDL2.Func([ProductId2], [IDL2.Opt(Product2)], ["query"]),
    "getProductsByCollection": IDL2.Func(
      [Collection2],
      [IDL2.Vec(Product2)],
      ["query"]
    ),
    "removeFromCart": IDL2.Func([ProductId2], [], []),
    "updateQuantity": IDL2.Func([ProductId2, IDL2.Nat], [], [])
  });
};
class Backend {
  ...
  async getProductsByCollection(arg0) {
    if (this.processError) {
      try {
  ...
  async updateQuantity(arg0, arg1) {
    if (this.processError) {
      try {
        const result = await this.actor.updateQuantity(arg0, arg1);
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
